...
const TX = {
  el: {
    ...
    verified: 'Ελεγμένο προφίλ από το Theralivo',
    ...
    classOf: 'Απόφοιτος',
    licenseNote: 'Η άδεια ασκήσεως επαγγέλματος έχει ελεγχθεί από την ομάδα του Theralivo.',
  ...
  en: {
    ...
    verified: 'Profile vetted by Theralivo',
    ...
    classOf: 'Class of',
    licenseNote: 'Professional license verified by the Theralivo team.',
