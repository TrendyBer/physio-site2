...
export default function RegisterPage() {
  ...
  async function handleRegister(e) {
    ...
    if (role === 'therapist') {
      ...
      router.push('/dashboard/therapist?welcome=true');
    } else {
      ...
      router.push('/dashboard/patient?welcome=true');
    }
    setLoading(false);
  }
        ...
        {step === 1 && (
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 24 }}>
              {[
                { id: 'patient', icon: '🏥', title: 'Ασθενής', desc: 'Κλείνω ραντεβού φυσιοθεραπείας' },
                { id: 'therapist', icon: '👨‍⚕️', title: 'Θεραπευτής', desc: 'Παρέχω υπηρεσίες φυσιοθεραπείας' },
              ].map(r => (
                <div key={r.id} onClick={() => setRole(r.id)}
                  ...
                  <div style={{ fontWeight: 700, color: '#1a2e44', marginBottom: 4 }}>{r.title}</div>
