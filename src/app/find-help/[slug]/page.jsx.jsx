...
export async function generateMetadata({ params, searchParams }) {
  ...
  // CANONICAL: η ελληνική εκδοχή αυτής της σελίδας είναι πλέον διπλότυπο
  // της /pathiseis/[slug] — ίδιο θέμα, ίδιο κείμενο. Δύο indexable σελίδες
  // για το ίδιο θέμα ανταγωνίζονται μεταξύ τους στη Google. Η σελίδα αυτή
  // μένει για τη λειτουργία του site, αλλά λέει στη Google ότι η επίσημη
  // είναι η /pathiseis. Η αγγλική (?lang=en) δεν έχει αντίστοιχο, οπότε
  // κρατά τον εαυτό της.
  const canonical = lang === 'en'
    ? `/find-help/${slug}?lang=en`
    : `/pathiseis/${slug}`;
